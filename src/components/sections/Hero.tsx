        ...
        >
          <div className="relative w-full max-w-[280px] lg:max-w-[320px] xl:max-w-[400px] aspect-[1/1.2]">
            ...
            <motion.div 
              ...
              className="absolute -top-6 -right-6 lg:-top-8 lg:-right-28 xl:-right-36 bg-white/95 backdrop-blur-md p-3 lg:p-5 rounded-2xl md:rounded-[2rem] shadow-2xl border border-white/20 z-20"
            >
              <div className="flex items-center gap-3 lg:gap-4">
