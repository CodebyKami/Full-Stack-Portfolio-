      ...
      <div className="container relative z-10 flex flex-col items-center justify-center flex-grow px-4 md:px-6 py-2 md:py-4 min-h-0">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center h-full">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center gap-0.5 md:gap-3 text-left md:text-center relative z-10">
                <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-foreground/90 whitespace-nowrap">
                  Full Stack Developer
                </span>
                <div className="hidden md:block w-[1px] h-3 bg-primary/20" />
                <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-primary whitespace-nowrap">
                  Automation Expert
                </span>
              </div>
            </motion.div>
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-4 w-full max-w-[260px] sm:max-w-none px-4 mx-auto"
          >
            <div className="w-full sm:w-auto">
              <Magnetic>
                <a href="#projects" className="block w-full">
                  <Button className="btn-primary w-full sm:min-w-[150px] md:min-w-[180px] h-10 md:h-12 px-6 md:px-8 text-xs md:text-sm rounded-full group">
                    View My Work
            ...
            <div className="w-full sm:w-auto">
              <Magnetic>
                <a href="#contact" className="block w-full">
                  <Button className="bg-white text-black hover:bg-surface border border-border/50 w-full sm:min-w-[150px] md:min-w-[180px] h-10 md:h-12 px-6 md:px-8 text-xs md:text-sm rounded-full font-bold shadow-sm">
                    Let's Talk
                  </Button>
                </a>
              </Magnetic>
